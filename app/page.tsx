      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-grid">
            ...
            <div>
              <h4 className="footer-title">Top Tutorials</h4>
              <nav className="footer-links">
                <Link href="/technologies/python" className="footer-link">Python Tutorial</Link>
                <Link href="/technologies/javascript" className="footer-link">JavaScript Tutorial</Link>
                <Link href="/technologies/react" className="footer-link">React.js Tutorial</Link>
                <Link href="/technologies/ai" className="footer-link">AI Tutorial</Link>
              </nav>
            </div>
            <div>
              <h4 className="footer-title">Technologies</h4>
              <nav className="footer-links">
                <Link href="/technologies/nextjs" className="footer-link">Next.js</Link>
                <Link href="/technologies/nodejs" className="footer-link">Node.js</Link>
                <Link href="/technologies/typescript" className="footer-link">TypeScript</Link>
                <Link href="/technologies/ai-agents" className="footer-link">AI Agents</Link>
              </nav>
            </div>
            <div>
              <h4 className="footer-title">Certifications</h4>
              <nav className="footer-links">
                <Link href="/certifications/python" className="footer-link">Python Certificate</Link>
                <Link href="/certifications/javascript" className="footer-link">JavaScript Certificate</Link>
                <Link href="/certifications/react" className="footer-link">React Certificate</Link>
                <Link href="/certifications/ai" className="footer-link">AI Certificate</Link>
              </nav>
            </div>
            <div>
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-bottom-links">
              ...
              <Link href="/cookies" className="footer-bottom-link">Cookies Policy</Link>
            </div>
          </div>
        </div>
      </footer>
