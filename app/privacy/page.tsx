    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">5. Cookies</h2>
            <p className="text-[var(--muted-foreground)]">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">6. Your Rights</h2>
            <div className="text-[var(--muted-foreground)] space-y-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">7. Contact Us</h2>
            <p className="text-[var(--muted-foreground)]">
              If you have questions about this Privacy Policy, please contact us at privacy@learnhub.com.
            </p>
          </section>
