      ...
      <div className="max-w-7xl mx-auto p-4 py-8 m-4">
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-[var(--text-secondary)] mt-1">Create and customize your professional resume</p>
          </div>
                    ...
                    <div key={index} className="bg-[var(--bg-card)] rounded-xl border border-[var(--border-primary)] p-6">
                      <div className="flex justify-between items-center mb-4">
                        <input
                          ...
                          className="text-lg font-medium bg-transparent text-[var(--text-primary)] focus:outline-none border-b border-transparent focus:border-[var(--bg-accent)]"
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 px-4 py-2 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-[var(--bg-accent)]"
                          onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                              addSkillItem(index, (e.target as HTMLInputElement).value);
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-[var(--bg-accent)] disabled:opacity-50"
                          />
                        </div>
                        <div className="md:col-span-2">
        ...
        <div className="mt-8 border-t border-[var(--border-primary)] pt-4 flex flex-wrap justify-end gap-2">
          <button onClick={handleSave} disabled={saving} className="btn btn-primary">
            {saving ? 'Saving...' : 'Save Resume'}
          </button>
          <button onClick={() => handleExport('pdf')} className="btn btn-secondary">
